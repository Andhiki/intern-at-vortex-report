...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox[c][6cm][c]{0.88\textwidth}{\centering Placeholder tangkapan layar daily stand-up atau koordinasi progres}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox[c][6cm][c]{0.88\textwidth}{\centering Placeholder tangkapan layar diskusi design library}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\parbox[c][6cm][c]{0.88\textwidth}{\centering Placeholder tangkapan layar diskusi teknis fitur Import Nilai Neon Uji}}
    \caption{Bukti diskusi teknis fitur Import Nilai Neon Uji}
    \label{fig:komunikasi_import_neon_uji}
\end{figure}

\begin{figure}[htbp]
    \centering
    \fbox{\parbox[c][6cm][c]{0.88\textwidth}{\centering Placeholder tangkapan layar training session intern}}
    \caption{Bukti kegiatan training session intern}
