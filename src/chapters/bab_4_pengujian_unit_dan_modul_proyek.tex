...
\section{Silabus}
Mahasiswa dapat menyusun desain pengujian unit dari perangkat lunak\slash modul\slash subsistem\slash prototip dan melakukan pengujian dengan mengunakan data uji untuk/dari kegiatan internship/MBKM. Deskripsi pengujian unit/modul dapat meliputi hal hal berikut:
\begin{enumerate}
	\item Deskripsi umum pengujian (tujuan pengujian, strategi/metode pengujian)
	\item Tool pengujian, library, add-in; atau plag-in, atau hardware (yang digunakan);
	...
	\item Hasil/luaran pengujian; atau validasi/verifikasi, dan pembasahan dari hasil uji.
\end{enumerate}
